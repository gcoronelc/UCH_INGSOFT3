...
public class CarritoController extends HttpServlet {
  ...
  private void carritoListar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    request.setAttribute("mayor", carrito.mayorPrecio());
    request.setAttribute("menor", carrito.menorPrecio());
    request.setAttribute("masVendido", carrito.getMasVendido());
    request.setAttribute("menosVendido", carrito.getMenosVendido());
    RequestDispatcher rd;
