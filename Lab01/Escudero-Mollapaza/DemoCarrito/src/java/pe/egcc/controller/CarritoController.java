...
@WebServlet(name = "CarritoController",
        urlPatterns = {"/CarritoAgregar", "/CarritoListar",
            "/CarritoReset", "/SessionReset", "/estadistica"})
public class CarritoController extends HttpServlet {
    ...
    private void carritoAgregar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Proceso
        ItemDto dto = new ItemDto(cliente, precio, cant, 0, articulo);
    ...
    private void estadistica(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        carrito = (CarritoModel) session.getAttribute("carrito");
        // forward
        request.setAttribute("dtomayor", carrito.mayorVenta());
        request.setAttribute("dtomenor", carrito.menorVenta());
        request.setAttribute("dtomayorprecio", carrito.mayorPrecio());
        request.setAttribute("dtomenorprecio", carrito.menorPrecio());
        RequestDispatcher rd;
